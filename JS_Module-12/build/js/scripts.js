...
var listCards = document.querySelector(".list");
...
var fetchUrl = function fetchUrl(url) {
  return fetch("https://api.linkpreview.net/?key=5bd3191e2f043b0485292cde20d8a76cca37410a9f115&q=" + url).then(function (response) {
